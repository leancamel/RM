...
#define M3508_MOTOR_RPM_TO_VECTOR 0.000831074173546131992427f  // 2PI/60/(3591/187 / 2) * (0.1524/2)
...
#define M3505_MOTOR_SPEED_PID_MAX_OUT (MAX_MOTOR_CAN_CURRENT + 1000)
