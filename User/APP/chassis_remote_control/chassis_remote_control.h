...
typedef enum
{
  CHASSIS_VECTOR_FOLLOW_GIMBAL_YAW,   //跟随云台模式
  CHASSIS_VECTOR_FOLLOW_CHASSIS_YAW,  //底盘矢量跟随底盘偏航
  CHASSIS_VECTOR_NO_FOLLOW_YAW,       //底盘矢量无跟随偏航
  CHASSIS_VECTOR_RAW,                 //底盘矢量raw（原始的），受遥控器控制方向

  //  CHASSIS_AUTO,                    //底盘自动
  //  CHASSIS_FOLLOW_YAW,              //底盘跟随偏航
  //  CHASSIS_ENCODER,                 //底盘编码器
  //  CHASSIS_NO_ACTION,               //底盘无动作
  //  CHASSIS_RELAX,                   //底盘放松
} chassis_mode_e;
